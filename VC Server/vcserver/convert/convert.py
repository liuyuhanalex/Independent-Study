...
from convert.model import CycleGAN
from convert.preprocess import *

def conversion(model_dir, model_name, file, conversion_direction, output_dir):
    ...
    librosa.output.write_wav(os.path.join(output_dir, "result.wav"), wav_transformed, sampling_rate)
